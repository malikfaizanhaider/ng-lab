...
import { ScrollbarGeometry, ScrollbarPosition } from '@unstyled/directives/scrollbar/scrollbar.types';
 ...
 */
@Directive({
    selector  : '[unsScrollbar]',
    exportAs  : 'unsScrollbar',
    standalone: true,
})
export class UnsScrollbarDirective implements OnChanges, OnInit, OnDestroy
{
    /* eslint-disable @typescript-eslint/naming-convention */
    static ngAcceptInputType_unsScrollbar: BooleanInput;
    /* eslint-enable @typescript-eslint/naming-convention */

    @Input() unsScrollbar: boolean = true;
    @Input() unsScrollbarOptions: PerfectScrollbar.Options;
    ...
    {
        // Enabled
        if ( 'unsScrollbar' in changes )
        {
            // Interpret empty string as 'true'
            this.unsScrollbar = coerceBooleanProperty(changes.unsScrollbar.currentValue);

            // If enabled, init the directive
            if ( this.unsScrollbar )
            {
                this._init();
            }
        ...
        // Scrollbar options
        if ( 'unsScrollbarOptions' in changes )
        {
            // Merge the options
            this._options = merge({}, this._options, changes.unsScrollbarOptions.currentValue);
